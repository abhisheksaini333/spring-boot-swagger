package com.edureka.springbootswagger2.controller;
...
import com.edureka.springbootswagger2.model.Student;
...
public class Swagger2DemoRestController {
	...
	@ApiResponses(value = { 
	  ...
	  @RequestMapping(value = "/getStudents") public List<Student> getStudents() {
	  return students; }
	...
	public Student getStudent(@PathVariable(value = "name") String name) {
	  ...
	  @ApiIgnore
	  @RequestMapping(value = "/getStudentByCountry/{country}") public
	  ...
	  System.out.println(studentsByCountry); return studentsByCountry; }
